...
const TIMELINE: { period: Dict<string>; title: Dict<string>; body: Dict<string> }[] = [
  ...
  },
  {
    ...
    body: {
      en: "The container was packed in Sydney by volunteers including Mamdouh Mansour, Philip Hanna, engineer Michael Elmasri, Emil Girgis and many others — and shipped via Mombasa, Kenya, then by road through Nadapal to Kapoeta South.",
      ar: "عبّأ المتطوّعون الحاوية في سيدني، ومنهم Mamdouh Mansour وPhilip Hanna، والمهندس Michael Elmasri، وEmil Girgis وكثيرون غيرهم — ثم شُحنت عبر مومباسا في كينيا، ومنها برًّا عبر نادابال إلى كاپويتا الجنوبية.",
    },
  },
  {
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-16 items-center">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="space-y-5 text-[#374151] text-lg leading-relaxed">
            ...
            <p>
              {t({
                en: "He found children there: approximately 320 boys and girls, sleeping near the local market, wearing tattered clothes, eating from trash bins, with no access to school. Hakim began with what he had — gathering them by day to teach basic lessons and songs, share one meal, and offer the safety of presence.",
                ar: "هناك وجد الأطفال: نحو 320 من الأولاد والبنات، ينامون قرب السوق المحلي، يرتدون ثيابًا رثّة، يأكلون من صناديق القمامة، بلا فرصة للالتحاق بالمدرسة. وبدأ حكيم بما لديه — يجمعهم نهارًا ليعلّمهم دروس أساسية وأناشيد، ويتقاسم معهم وجبة واحدة، ويمنحهم أمان الحضور.",
              })}
            </p>
          </motion.div>
