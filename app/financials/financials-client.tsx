...
import type { ReportItem } from "@/lib/admin/store";
...
export function FinancialsClient({ reports }: { reports: ReportItem[] }) {
  const t = useT();
...
function AnnualReports({ reports }: { reports: ReportItem[] }) {
  const t = useT();
          ...
          {hasReports ? (
              ...
              >
                <div className="flex items-center gap-4 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-[#9ca3af]">{r.year}</p>
                  </div>
                </div>
                <a
                  href={r.url}
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold bg-[#6366f1] text-white hover:bg-[#4f46e5] transition-colors flex-shrink-0"
                >
            ...
            >
              <div className="flex items-center gap-4">
                <FileDown size={20} className="text-[#6366f1] flex-shrink-0" strokeWidth={1.75} />
                <div>
                  <p className="text-sm font-semibold text-[#1e293b]">FY 2024–25</p>
                  <p className="text-xs text-[#9ca3af]">1 July 2024 – 30 June 2025</p>
                </div>
              </div>
