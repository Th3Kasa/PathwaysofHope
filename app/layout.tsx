...
export const metadata: Metadata = {
  ...
  description:
    "A faith-driven Australian charity partnering with local leaders to bring safety, education and a sustainable future to children in Kapoeta, South Sudan. 100% of donations support the children.",
