...
export const GOAL_AR: Record<GoalId, GoalArText> = {
  ...
  "chicken-coop": {
    ...
    imageAlt: "محصول ذرة ينمو في أرض ملجأ كاپويتا — حظيرة الدجاج ستضيف البيض إلى نفس منظومة الغذاء المكتفية ذاتيًا",
    parts: {
      coop: {
  ...
  "sponsor-a-child": {
    ...
    imageAlt: "أطفال يلعبون بحرية في ملجأ كاپويتا — الطفولة الآمنة المبهجة التي تتيحها كفالتك",
  },
  "where-most-needed": {
    title: "تبرّع مخصَّص",
    short:
      "اختر أيّ مبلغ تشاء — يُوجَّه إلى حيثما تكون الحاجة أشدّ في الملجأ الآن.",
    description:
      "لست متأكّدًا من اختيار المشروع؟ حدّد مبلغك الخاصّ وسنوجّهه إلى أشدّ المجالات حاجةً — الطعام أو الرعاية الطبية أو التعليم أو المرحلة البنائية التالية. تبرّع مرةً واحدة أو ادعم بشكل منتظم. كل دولار يصل إلى ملجأ كاپويتا للأطفال.",
    imageAlt: "أطفال مجتمعون في ملجأ كاپويتا للأطفال",
  },
};
