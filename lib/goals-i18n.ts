...
export const GOAL_AR: Record<GoalId, GoalArText> = {
  ...
  "sponsor-a-child": {
    ...
    description:
      "A$600 تغطّي سنةً كاملة لطفل واحد: وجبات وسرير آمن وتعليم وكرامة الانتماء. من بين 70 طفلاً في رعايتنا، 46 الآن في المدرسة — و24 ما زالوا في انتظار الكفالة. اكفل ما شئت منهم.",
